 ...
 * @link http://www.webkinder.ch.com
 * @license https://github.com/webkinder/wp-cli-csv-import/blob/master/LICENSE.md MIT
 * @version 0.0.1
 *
 * Contributors: Jeff Sebring <jeff@jeffsebring.com>
 */
...
class ImportCSV_Command extends WP_CLI_Command {
	...
	private function _read() {
		...
		if ( ! $this->csv = fgetcsv( $this->file, 0, ';' ) ) {
